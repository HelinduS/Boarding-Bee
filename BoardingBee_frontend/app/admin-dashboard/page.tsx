      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="mt-8">
          <TabsList className="w-full grid grid-cols-4 gap-0 p-1 rounded-xl bg-indigo-50/60 dark:bg-slate-800/40 border border-border/60 shadow-sm">
            ...
            <TabsTrigger
              value="users"
              className="flex items-center justify-center gap-2 px-4 py-3 text-sm font-medium text-muted-foreground transition hover:bg-muted/70 rounded-lg data-[state=active]:bg-gradient-to-r data-[state=active]:from-violet-600 data-[state=active]:to-blue-500 data-[state=active]:text-white data-[state=active]:shadow-md data-[state=active]:font-semibold focus-visible:outline-none"
            >
