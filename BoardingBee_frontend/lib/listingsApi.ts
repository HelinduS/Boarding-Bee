...
export async function fetchListing(id: string, token?: string): Promise<Listing> {
...
export async function updateListing(id: string, data: any, token: string) {
...
export async function renewListing(id: string, token: string) {
