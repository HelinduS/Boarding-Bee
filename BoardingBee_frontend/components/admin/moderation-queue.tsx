            ...
            <div key={l.id} className="w-full rounded-xl border p-4 flex items-center gap-4 transition-shadow duration-150 hover:shadow-md hover:border-gray-200 dark:hover:border-slate-700 bg-white dark:bg-slate-900">
              ...
              <div className="flex-1">
                ...
                <div className="flex gap-3 mt-4">
                  ...
                  {activeTab !== "approved" && (
                    <button onClick={() => approve(l.id)} className="rounded-md px-3 py-1.5 text-sm bg-green-600 text-white hover:bg-green-700 transition-colors">Approve</button>
                  )}
                  {activeTab !== "rejected" && (
                    <button onClick={() => reject(l.id)} className="rounded-md px-3 py-1.5 text-sm bg-red-600 text-white hover:bg-red-700 transition-colors">Reject</button>
                  )}
                </div>
              </div>
            </div>
